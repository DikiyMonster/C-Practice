...
class Circle
{
	...
	public:
		...
		void Print()
		{
			cout <<"Формула площади круга Pi * Радиус^2"<<endl;
		}
};
...
class Triangle
{
	...
	void Print()
	{
		cout<<"Формула площади треугольника 0,5 * Основание * Высоту"<<endl;
	}
...
int main()
{
	...
	cout<<"Площадь треугольника = "<<myWarningTriangle.Area()<<endl;
